...
`;
    ...
    const prompt = `Tell the story of this development period through a structured JSON response that will be converted to a Slidev presentation. Focus on the NARRATIVE - what happened, why it mattered, and how it all connects together.
